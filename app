...
<head>
    ...
    <style>
        ...
        /* The Actual YouTube Iframe (Hidden behind our logic) */
        .video-wrapper iframe { position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none; pointer-events: none; /* DISABLES CLICKING ON YOUTUBE DIRECTLY */ }
...
<body>
    ...
    <script>
        ...
        function onYouTubeIframeAPIReady() {
            // Player will be created when user clicks a video
        }
        ...
        function openSubject(subject) {
            ...
            subject.videos.forEach(video => {
                ...
                item.onclick = () => playLecture(video); // Note: videoId logic changed for YouTube
        ...
        function playLecture(video) {
            ...
            createPlayer(video.youtubeId); // Assuming data.js uses youtubeId
